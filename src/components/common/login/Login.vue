		...
		<div class="loginAndregist" v-bind:class="getClass()">
			<div class="login">
				<div>
					...
					<input class="textinput" type="text" placeholder="请输入账户" v-model="logInfo.username"
						@input="logEmptyFunction">
					...
					<input class="textinput" type="password" placeholder="请输入密码" v-model="logInfo.password"
						@input="logEmptyFunction">
					<div style="margin-left: 18%;margin-top: 3px;">
						<a href="">忘记密码</a>
			...
			<div class="regist">
				<div>
					...
					<input class="textinput" type="text" placeholder="请输入账户" v-model="regInfo.username"
						@input="regEmptyFunction">
					<div style="margin-left: 18%;margin-top: 30px;">输入密码</div>
					<input class="textinput" type="password" placeholder="请输入密码" v-model="regInfo.password1"
						@input="regEmptyFunction">
					<div style="margin-left: 18%;margin-top: 30px;">确认密码</div>
					<input class="textinput" type="password" placeholder="请确认密码" v-model="regInfo.password2"
						@input="regEmptyFunction">
...
<script>
	export default {
		...
		methods: {
			...
			loginBtnActive() {
				return {
					btnActive: this.logEmpty
				}
			},
			regBtnActive() {
				return {
					btnActive: this.regEmpty
				}
			},
